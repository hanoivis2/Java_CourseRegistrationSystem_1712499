...
public class CreateSubjectForm extends JPanel implements ActionListener {
	...
	public CreateSubjectForm(Action actionFresh) throws IOException, URISyntaxException {
        ...
        frame = new JFrame("Add new subject");
		...
		btn_confirm = new JButton("Add subject");
		...
		if (strActionCommand.equals("Confirm"))
		{
			...
			try {
				...
				if (txt_id.getText().equals("Enter subject' id...")) {
					...
					int status = SubjectDAO.addSubject(newSubject);
					if (status == -1) {
