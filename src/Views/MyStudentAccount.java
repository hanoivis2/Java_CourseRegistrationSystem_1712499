...
public class MyStudentAccount extends JPanel implements ActionListener {
	...
	public MyStudentAccount(String studentId) throws IOException, URISyntaxException {
		super(new BorderLayout());
		
		this.accountData = StudentAccountDAO.getStudentAccountById(studentId);
